...
TCoord demandeJoueur(void) {
    ...
    do{
        ...
        l_int_coordY = _getch();
        Sleep(100);
        if ((l_int_coordY <= 96)||(l_int_coordY > 102))
        {
           printf("Mauvaise frappe !\n\n");
        } 
        
        printf("Saisir la colonne : \n");
        scanf_s("%i", &l_int_coordX);
        
    }while (((l_int_coordY <= 96) || (l_int_coordY > 102))||((l_int_coordX < 1) || (l_int_coordX > 6)));
